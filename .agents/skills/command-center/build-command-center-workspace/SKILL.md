...
## Assess Contract Changes

Route workspace, layout, widget instance, binding, props, user-state, and snapshot shape changes
through `$evolve-command-center-contract`.
