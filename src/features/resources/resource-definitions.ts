import type { ApiMethod } from "@/lib/api/client";
...
export const accountsDefinition: ResourceDefinition = {
  ...
  detailPath: (uid) => `/api/v1/account/${uid}/`,
  detailOperationId: "getAccount",
  columns: [
  ...
  details: [
    { title: "Summary", operationId: "getAccountSummary", path: (uid) => `/api/v1/account/${uid}/summary/` },
...
export const pricingCurvesDefinition: ResourceDefinition = {
  ...
  detailPath: (uid) => `/api/v1/pricing/curves/${uid}/`,
  detailOperationId: "getPricingCurve",
  columns: [
    { key: "display_name", label: "Name", priority: "primary" },
    { key: "unique_identifier", label: "Identifier" },
  ...
  details: [
    { title: "Summary", operationId: "getPricingCurveSummary", path: (uid) => `/api/v1/pricing/curves/${uid}/summary/` },
